...
namespace TechStoreWinApp
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void BtnSendAboutMsg_Click(object? sender, EventArgs e)
        {
            ...
            MessageBox.Show($"Cảm ơn bạn {name}!\nChúng tôi đã nhận được phản hồi và sẽ phản hồi lại bạn qua email {email} sớm nhất.", "Gửi Liên Hệ Thành Công", MessageBoxButtons.OK, MessageBoxIcon.Information);
            RefreshAboutPage();
        }
